...
const char websiteSource[] PROGMEM =
  ...
  "            }\n"
  "            if (\"BrightSunny\" in jsonMessage) {\n"
  "                // console.log(\"Found Rainbow Message\")\n"
  "                handleBrightSunnyMessage(jsonMessage.BrightSunny)\n"
  "            }\n"
  ...
  "                    }\n"
  "                }\n"
  "                if ((\"Saturation\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.Saturation === \"number\") {\n"
  "                        $(\"#rainbowSaturation\").val(Math.round(jsonMessage.Saturation / 255 * 100))\n"
  "                        $(\"#rainbowSaturationLabel\").html(Math.round(jsonMessage.Saturation / 255 * 100))\n"
  "                    }\n"
  "                }\n"
  "            }\n"
  "        }\n"
  "\n"
  "        function handleBrightSunnyMessage(jsonMessage) {\n"
  "            if (typeof jsonMessage === \"object\") {\n"
  "                if ((\"Speed\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.Speed === \"number\") {\n"
  "                        $(\"#sunnySpeed\").val(jsonMessage.Speed)\n"
  "                        $(\"#sunnySpeedLabel\").html(jsonMessage.Speed)\n"
  "                    }\n"
  "                }\n"
  "                if ((\"BrightExtend\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.BrightExtend === \"number\") {\n"
  "                        $(\"#sunnyBrightExtend\").val(jsonMessage.BrightExtend)\n"
  "                        $(\"#sunnyBrightExtendLabel\").html(jsonMessage.BrightExtend)\n"
  "                    }\n"
  "                }\n"
  "                if ((\"BrightBrightness\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.BrightBrightness === \"number\") {\n"
  "                        $(\"#sunnyBrightBrightness\").val(Math.round(jsonMessage.BrightBrightness / 255 * 100))\n"
  "                        $(\"#sunnyBrightBrightnessLabel\").html(Math.round(jsonMessage.BrightBrightness / 255 * 100))\n"
  "                    }\n"
  "                }\n"
  "                if ((\"BrightSaturation\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.BrightSaturation === \"number\") {\n"
  "                        $(\"#sunnyBrightSaturation\").val(Math.round(jsonMessage.BrightSaturation / 255 * 100))\n"
  "                        $(\"#sunnyBrightSaturationLabel\").html(Math.round(jsonMessage.BrightSaturation / 255 * 100))\n"
  "                    }\n"
  "                }\n"
  "                if ((\"NormalBrightness\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.NormalBrightness === \"number\") {\n"
  "                        $(\"#sunnyNormalBrightness\").val(Math.round(jsonMessage.NormalBrightness / 255 * 100))\n"
  "                        $(\"#sunnyNormalBrightnessLabel\").html(Math.round(jsonMessage.NormalBrightness / 255 * 100))\n"
  "                    }\n"
  "                }\n"
  "                if ((\"NormalSaturation\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.NormalSaturation === \"number\") {\n"
  "                        $(\"#sunnyNormalSaturation\").val(Math.round(jsonMessage.NormalSaturation / 255 * 100))\n"
  "                        $(\"#sunnyNormalSaturationLabel\").html(Math.round(jsonMessage.NormalSaturation / 255 * 100))\n"
  "                    }\n"
  "                }\n"
  "            }\n"
  "        }\n"
  ...
  "                    </li>\n"
  "                    <li id=\"brightSunnyTabNavItem\" class=\"nav-item\">\n"
  "                        <a class=\"nav-link\" data-toggle=\"tab\" href=\"#BrightSunny\">BrightSunny</a>\n"
  "                    </li>\n"
  ...
  "                    });\n"
  "                    $(\"#brightSunnyTabNavItem\").click(function () {\n"
  "                        sendMessage({ \"Mode\": \"BrightSunny\" })\n"
  "                    });\n"
  ...
  "            <button id=\"brightSunnyButton\" type=\"submit\" class=\"col mb-2 mx-2 btn btn-lg btn-outline-light\">BrightSunny</button>\n"
  ...
  "                    sendMessage({ \"Mode\": \"Rainbow\" })\n"
  "                });\n"
  "                $(\"#brightSunnyButton\").click(function () {\n"
  "                    $('#navbarHeader a[href=\"#BrightSunny\"]').tab('show')\n"
  "                    sendMessage({ \"Mode\": \"BrightSunny\" })\n"
  "                });\n"
  ...
  "                            }\n"
  "                        }\n"
  "                        if (Date.now() - colourDebounce > 50) {\n"
  "                            colourDebounce = Date.now()\n"
  "                            sendMessage(msg)\n"
  "                        }\n"
  "                    }\n"
  "                }\n"
  ...
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"rainbowSaturation\">Rainbow Saturation: <span id=\"rainbowSaturationLabel\">100</span>%</label>\n"
  "                <input id=\"rainbowSaturation\" type=\"range\" min=\"0\" max=\"100\" step=\"1\" value=\"100\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"rainbowSpeed\">Rainbow Speed: <span id=\"rainbowSpeedLabel\">10</span> seconds</label>\n"
  "                <input id=\"rainbowSpeed\" type=\"range\" min=\"0\" max=\"60\" step=\"1\" value=\"10\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <script>\n"
  "                var rainbowDebounce = Date.now()\n"
  ...
  "                    onRainbowEvent()\n"
  "                });\n"
  "                $(\"#rainbowSaturation\").on(\"input\", function () {\n"
  "                    onRainbowEvent()\n"
  "                });\n"
  "                $(\"#rainbowSaturation\").on(\"change\", function () {\n"
  "                    onRainbowEvent()\n"
  "                });\n"
  "\n"
  ...
  "                    let currentSaturationValue = parseInt($(\"#rainbowSaturation\").val(), 10)\n"
  "\n"
  "                    $(\"#rainbowSpeed\").val = 0;\n"
  "                    $(\"#rainbowSpeedLabel\").html(0)\n"
  "                    $(\"#rainbowHueLabel\").html(currentHueValue)\n"
  "                    $(\"#rainbowBrightnessLabel\").html(currentBrightnessValue)\n"
  "                    $(\"#rainbowSaturationLabel\").html(currentSaturationValue)\n"
  "\n"
  "                    msg = {\n"
  "                        \"State\": true,\n"
  "                        \"Mode\": \"Rainbow\",\n"
  ...
  "                            \"Saturation\": Math.round(currentSaturationValue / 100 * 255)\n"
  "                        }\n"
  "                    }\n"
  "\n"
  "                    if (msg != rainbowLastMessage && Date.now() - rainbowDebounce > 50) {\n"
  "                        rainbowDebounce = Date.now()\n"
  ...
  "        </div>\n"
  "\n"
  "        <div id=\"BrightSunny\" class=\"container pb-5 tab-pane fade\">\n"
  "            <h2>BrightSunny Mode</h2>\n"
  "            <p>Here you can set the mode to brightSunny. This mode produces a brightSunny all the way around the light and\n"
  "                slowly shifts the colours clockwise. On this page you can set the speed of this as well as the\n"
  "                brightness of the light</p>\n"
  "            <div>\n"
  "                <label for=\"sunnySpeed\">Speed: <span id=\"sunnySpeedLabel\">10</span> seconds</label>\n"
  "                <input id=\"sunnySpeed\" type=\"range\" min=\"0\" max=\"60\" step=\"1\" value=\"10\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "\n"
  "            <div>\n"
  "                <label for=\"sunnyBrightExtend\">Extend Bright Section by: <span id=\"sunnyBrightExtendLabel\">0</span> lights</label>\n"
  "                <input id=\"sunnyBrightExtend\" type=\"range\" min=\"0\" max=\"56\" step=\"1\" value=\"0\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "\n"
  "            <div>\n"
  "                <label for=\"sunnyBrightBrightness\">Bright Section Brightness: <span id=\"sunnyBrightBrightnessLabel\">100</span>%</label>\n"
  "                <input id=\"sunnyBrightBrightness\" type=\"range\" min=\"0\" max=\"100\" step=\"1\" value=\"100\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"sunnyBrightSaturation\">Bright Section Saturation: <span id=\"sunnyBrightSaturationLabel\">100</span>%</label>\n"
  "                <input id=\"sunnyBrightSaturation\" type=\"range\" min=\"0\" max=\"100\" step=\"1\" value=\"100\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "\n"
  "            <div>\n"
  "                <label for=\"sunnyNormalBrightness\">Normal Section Brightness: <span id=\"sunnyNormalBrightnessLabel\">100</span>%</label>\n"
  "                <input id=\"sunnyNormalBrightness\" type=\"range\" min=\"0\" max=\"100\" step=\"1\" value=\"100\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"sunnyNormalSaturation\">Normal Section Saturation: <span id=\"sunnyNormalSaturationLabel\">100</span>%</label>\n"
  "                <input id=\"sunnyNormalSaturation\" type=\"range\" min=\"0\" max=\"100\" step=\"1\" value=\"100\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "\n"
  "\n"
  "            <script>\n"
  "                var brightSunnyDebounce = Date.now()\n"
  "                var brightSunnyLastMessage = \"\"\n"
  "\n"
  "                $(\"#sunnySpeed\").on(\"input\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnySpeed\").on(\"change\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyBrightExtend\").on(\"input\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyBrightExtend\").on(\"change\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyBrightBrightness\").on(\"input\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyBrightBrightness\").on(\"change\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyBrightSaturation\").on(\"input\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyBrightSaturation\").on(\"change\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyNormalBrightness\").on(\"input\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyNormalBrightness\").on(\"change\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyNormalSaturation\").on(\"input\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "                $(\"#sunnyNormalSaturation\").on(\"change\", function () {\n"
  "                    onBrightSunnyEvent()\n"
  "                });\n"
  "\n"
  "                function onBrightSunnyEvent() {\n"
  "                    let currentSpeedValue = parseFloat($(\"#sunnySpeed\").val())\n"
  "                    let currentBrightExtendValue = parseFloat($(\"#sunnyBrightExtend\").val())\n"
  "                    let currentBrightBrightnessValue = parseInt($(\"#sunnyBrightBrightness\").val(), 10)\n"
  "                    let currentBrightSaturationValue = parseInt($(\"#sunnyBrightSaturation\").val(), 10)\n"
  "                    let currentNormalBrightnessValue = parseInt($(\"#sunnyNormalBrightness\").val(), 10)\n"
  "                    let currentNormalSaturationValue = parseInt($(\"#sunnyNormalSaturation\").val(), 10)\n"
  "\n"
  "                    $(\"#sunnySpeedLabel\").html(currentSpeedValue)\n"
  "                    $(\"#sunnyBrightExtendLabel\").html(currentBrightExtendValue)\n"
  "                    $(\"#sunnyBrightBrightnessLabel\").html(currentBrightBrightnessValue)\n"
  "                    $(\"#sunnyBrightSaturationLabel\").html(currentBrightSaturationValue)\n"
  "                    $(\"#sunnyNormalBrightnessLabel\").html(currentNormalBrightnessValue)\n"
  "                    $(\"#sunnyNormalSaturationLabel\").html(currentNormalSaturationValue)\n"
  "\n"
  "                    msg = {\n"
  "                        \"State\": true,\n"
  "                        \"Mode\": \"BrightSunny\",\n"
  "                        \"BrightSunny\": {\n"
  "                            \"Speed\": currentSpeedValue,\n"
  "                            \"BrightExtend\": currentBrightExtendValue,\n"
  "                            \"BrightBrightness\": Math.round(currentBrightBrightnessValue / 100 * 255),\n"
  "                            \"BrightSaturation\": Math.round(currentBrightSaturationValue / 100 * 255),\n"
  "                            \"NormalBrightness\": Math.round(currentNormalBrightnessValue / 100 * 255),\n"
  "                            \"NormalSaturation\": Math.round(currentNormalSaturationValue / 100 * 255)\n"
  "                        }\n"
  "                    }\n"
  "\n"
  "                    if (msg != brightSunnyLastMessage && Date.now() - brightSunnyDebounce > 50) {\n"
  "                        brightSunnyDebounce = Date.now()\n"
  "                        brightSunnyLastMessage = msg\n"
  "                        sendMessage(msg)\n"
  "                    }\n"
  "                }\n"
  "            </script>\n"
  ...
  "\n"
  "            <script>\n"
  "                clockHourDebounce = Date.now()\n"
  "                clockMinDebounce = Date.now()\n"
  ...
  "                        }\n"
  "\n"
  "                        if (Date.now() - clockHourDebounce > 50) {\n"
  "                            clockHourDebounce = Date.now()\n"
  "                            sendMessage(msg)\n"
  "                        }\n"
  "                    }\n"
  ...
  "                        }\n"
  "\n"
  "                        if (Date.now() - clockMinDebounce > 50) {\n"
  "                            clockMinDebounce = Date.now()\n"
  "                            sendMessage(msg)\n"
  "                        }\n"
  "                    }\n"
  ...
  "                        }\n"
  "\n"
  "                        if (Date.now() - bellCurveDebounce > 50) {\n"
  "                            bellCurveDebounce = Date.now()\n"
  "                            sendMessage(msg)\n"
  "                        }\n"
  "                    }\n"
  ...
  "                    }\n"
  "\n"
  "                    if (msg != sparkleLastMessage && Date.now() - sparkleDebounce > 50) {\n"
  "                        sparkleDebounce = Date.now()\n"
  ...
  "                            }\n"
  "                        }\n"
  "                        if (Date.now() - sparkleDebounce > 50) {\n"
  "                            sparkleDebounce = Date.now()\n"
  "                            sendMessage(msg)\n"
  "                        }\n"
  "                    }\n"
  ...
  "                var colorWipeBlue = 0\n"
  "                var colorWipeDebounce = Date.now()\n"
  "\n"
  ...
  "                        }\n"
  "\n"
  "                        if (Date.now() - colorWipeDebounce > 50) {\n"
  "                            colorWipeDebounce = Date.now()\n"
  "                            sendMessage(msg)\n"
  "                        }\n"
  "                        if (msg != colorWipeLastMessage && Date.now() - colorWipeDebounce > 50) {\n"
  "                            colorWipeDebounce = Date.now()\n"
  ...
  "                    }\n"
  "\n"
  "                    if (msg != confettiLastMessage && Date.now() - confettiDebounce > 50) {\n"
  "                        confettiDebounce = Date.now()\n"
  ...
  "                            }\n"
  "                        }\n"
  "                        if (Date.now() - confettiDebounce > 50) {\n"
  "                            confettiDebounce = Date.now()\n"
  "                            sendMessage(msg)\n"
  "                        }\n"
  "                    }\n"
  ...
  "            </div>\n"
  "            <script>\n"
  "                var firefliesDebounce = Date.now()\n"
  "\n"
  ...
  "                    }\n"
  "\n"
  "                    if (Date.now() - firefliesDebounce > 50) {\n"
  "                        firefliesDebounce = Date.now()\n"
  "                        sendMessage(msg)\n"
  "                    }\n"
  "                }\n"
  "            </script>\n"
  ...
  "            </div>\n"
  "            <script>\n"
  "                var saturationFadeDebounce = Date.now()\n"
  "\n"
  ...
  "                    }\n"
  "\n"
  "                    if (Date.now() - saturationFadeDebounce > 50) {\n"
  "                        saturationFadeDebounce = Date.now()\n"
  "                        sendMessage(msg)\n"
  "                    }\n"
  "                }\n"
  "            </script>\n"
  ...
  "\n"
  "            <script>\n"
  "                var visualiserDebounce = Date.now()\n"
  ...
  "                    }\n"
  "\n"
  "                    if (msg != lastVisualiserMessaeg && Date.now() - visualiserDebounce > 50) {\n"
  "                        lastVisualiserMessaeg = msg\n"
  "                        visualiserDebounce = Date.now()\n"
  "                        sendMessage(msg)\n"
  "                    }\n"
  "                }\n"
  "            </script>\n"
