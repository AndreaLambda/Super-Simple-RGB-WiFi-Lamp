...
const char websiteSource[] PROGMEM =
  ...
  "\n"
  "            <script>\n"
  "                let brightSunnyDebounce = Date.now()\n"
  "                let brightSunnyLastMessage = \"\"\n"
  "\n"
  "                function addSliderEvents(id) {\n"
  ...
  "                }\n"
  "\n"
  "                addSliderEvents(\"#sunnySpeed\");\n"
  "                addSliderEvents(\"#sunnyBrightExtend\");\n"
  "                addSliderEvents(\"#sunnyBrightBrightness\");\n"
  "                addSliderEvents(\"#sunnyBrightSaturation\");\n"
  "                addSliderEvents(\"#sunnyNormalBrightness\");\n"
  "                addSliderEvents(\"#sunnyNormalSaturation\");\n"
  "\n"
  "                const PASSTHROUGH = (value) => value;\n"
  "                const pctToUint = (value) => Math.round(value / 100 * 255);\n"
  "\n"
  "                function parseAndUpdateLabel(id, parseFn, valueFn = PASSTHROUGH, defaultValue = 0) {\n"
  "                    const labelId = `${id}Label`;\n"
  "                    const currentValue = parseFn($(id).val(), defaultValue);\n"
  "                    $(labelId).html(currentValue);\n"
  ...
  "                        \"Mode\": \"BrightSunny\",\n"
  "                        \"BrightSunny\": {\n"
  "                            \"Speed\": parseAndUpdateLabel(\"#sunnySpeed\", parseFloat),\n"
  "                            \"BrightExtend\": parseAndUpdateLabel(\"#sunnyBrightExtend\", parseFloat),\n"
  "                            \"BrightBrightness\": parseAndUpdateLabel(\"#sunnyBrightBrightness\", parseInt, pctToUint),\n"
  "                            \"BrightSaturation\": parseAndUpdateLabel(\"#sunnyBrightSaturation\", parseInt, pctToUint),\n"
  "                            \"NormalBrightness\": parseAndUpdateLabel(\"#sunnyNormalBrightness\", parseInt, pctToUint),\n"
  "                            \"NormalSaturation\": parseAndUpdateLabel(\"#sunnyNormalSaturation\", parseInt, pctToUint),\n"
  "                        }\n"
  "                    }\n"
  "\n"
  "                    if (msg != brightSunnyLastMessage && Date.now() - brightSunnyDebounce > 100) {\n"
